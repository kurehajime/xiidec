...
(function(){
    ...
    aijs.evalMap=function(wkMap,turn_player){
        var ev=0;
        var evMap=aijs.copyMap(wkMap);
    ...
    aijs.thinkAI=function(map,turn_player,depth,a,b){
        if(isEndX(map)!=0){
            nearwin=true;
        }
    ...
    function getNodeMap(wkMap,turn_player){
        ...
        for(var panel_num in wkMap){
            ...
            for(var num in canMove){
                var nodeMap=aijs.copyMap(wkMap);
                var q=[];
    ...
    function deepThinkAllAB(map,turn_player,depth,a,b){
        ...
        var besthand;
        if(depth==0){
            best_score=aijs.evalMap(map,turn_player);
